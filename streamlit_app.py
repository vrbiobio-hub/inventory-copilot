...
if workspace in ["Resumen","Summary"]:
    ...
    if st.session_state.category_detail:
        ...
        cols=["Ranking","Score","SKU","Estado inventario","Safety Stock","ROP","Action","Cantidad","Impacto","Quiebre","Confidence","Por qué"]
    ...
    st.dataframe(top[["Ranking","Score","Categoría","SKU","Estado inventario","Safety Stock","ROP","Action","Cantidad","Impacto","Quiebre","Confidence"]],use_container_width=True,hide_index=True,height=520)
