...
view=result.copy()
for c in ["Purchase_value","Excess_value","Recommended_qty","Forecast_weekly","On_hand"]:
...
nav_es=["Resumen","Acciones","Inventario","Forecast","Simulador"]
nav_en=["Summary","Actions","Inventory","Forecast","Simulator"]
nav=nav_es if lang=="es" else nav_en
# normalize language switches
aliases={"Actions":"Acciones","Summary":"Resumen","Inventory":"Inventario","Simulator":"Simulador","Acciones":"Actions","Resumen":"Summary","Inventario":"Inventory","Simulador":"Simulator"}
